...
public class OrderController {
    ...
    public int saveOrder(@RequestBody OrderDTO order) throws Exception{
        ...
        try {
            ...
            PreparedStatement stmOrder = connection.prepareStatement("INSERT INTO `order` (datetime) VALUES (?)", Statement.RETURN_GENERATED_KEYS);
            ...
            if (order.getCustomer() != null) {
                PreparedStatement stmOrderCustomer = connection.prepareStatement("INSERT INTO order_customer (order_id, customer_id) values (?,?)");
            ...
            PreparedStatement stmOrderItem = connection.prepareStatement("INSERT INTO order_detail (order_id, item_code, unit_price, qty) VALUES (?,?,?,?)");
